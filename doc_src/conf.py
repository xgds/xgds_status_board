...
version = xgds_status_board.get_version()
# The full version, including alpha/beta/rc tags.
release = xgds_status_board.get_version()
...
htmlhelp_basename = 'xgds_status_boarddoc'
